Namespace CommonRoutines.Registry
    ...
    Public Module _Shared
        ...
        Private Function [Get](keyName As String, valueName As String, ByRef value As Object) As Boolean
            ...
            Try
                Dim SubKey As String = keyName.Substring(keyName.IndexOf("\", Settings.StringComparison) + 1).Replace("\", "\\")
                Dim TopKey As String = keyName.Substring(0, keyName.IndexOf("\"))
                ...
                Try
                    value = My.Computer.Registry.GetValue(keyName, valueName, Nothing)
                Catch exInner As Exception
                    exInner.ToLog(True)
                    value = Nothing
                End Try
        ...
        Private Function [Set](keyName As String, registryValueKind As Microsoft.Win32.RegistryValueKind, registryView As Microsoft.Win32.RegistryView, valueName As String, value As Object) As Boolean
            Try
                Dim SubKey As String = keyName.Substring(keyName.IndexOf("\") + 1).Replace("\", "\\")
                Dim TopKey As String = keyName.Substring(0, keyName.IndexOf("\"))
            ...
            Catch ex As Exception
                ...
                Try
                    My.Computer.Registry.SetValue(keyName, valueName, value, registryValueKind)
