        ...
        <Runtime.CompilerServices.Extension()> Public Sub SetTheme(ByRef c As Control)
            ...
            Else
                Select Case FullName
                    Case "CommonRoutines.UserControls.Button"
                        Dim Item As UserControls.Button = DirectCast(c, UserControls.Button)
                    ...
                    Case "CommonRoutines.UserControls.CheckBox"
                        Dim Item As UserControls.CheckBox = DirectCast(c, UserControls.CheckBox)
                        Item.BackColor = Item.Parent.BackColor
                        Item.ForeColor = UITheme.ForeColor
                    ...
                    Case "CommonRoutines.UserControls.ComboBox"
                        Dim Item As UserControls.ComboBox = DirectCast(c, UserControls.ComboBox)
                        Item.BackColor = Item.Parent.BackColor
                        Item.BorderColor = UITheme.BorderColor
                        Item.ForeColor = UITheme.ForeColor
                    ...
                    Case "CommonRoutines.UserControls.DateTimePicker"
                        Dim Item As UserControls.DateTimePicker = DirectCast(c, UserControls.DateTimePicker)
                        Item.BackColor = Item.Parent.BackColor
                        Item.BorderColor = UITheme.BorderColor
                        Item.ForeColor = UITheme.ForeColor

                    Case "CommonRoutines.UserControls.DBDataGridView"
                        Dim Item As UserControls.DBDataGridView = DirectCast(c, UserControls.DBDataGridView)
                    ...
                    Case "CommonRoutines.UserControls.DBTableLayoutPanel"
                        Dim Item As UserControls.DBTableLayoutPanel = DirectCast(c, UserControls.DBTableLayoutPanel)
                        Item.BackColor = UITheme.BackColor

                    Case "CommonRoutines.UserControls.DropdownMenu"
                        Dim Item As UserControls.DropdownMenu = DirectCast(c, UserControls.DropdownMenu)
                        Item.PrimaryColor = UITheme.BackColor
                        Item.MenuItemTextColor = UITheme.ForeColor

                        Return

                    Case "CommonRoutines.UserControls.ListResults"
                        Dim Item As UserControls.ListResults = DirectCast(c, UserControls.ListResults)
                        Item.BackColor = Item.Parent.BackColor
                        Item.BorderColor = UITheme.BorderColor
                    ...
                    Case "CommonRoutines.UserControls.PictureBox"
                        Dim Item As UserControls.PictureBox = DirectCast(c, UserControls.PictureBox)
                        Item.BackColor = Item.Parent.BackColor
                        Item.ForeColor = UITheme.ForeColor
                        Item.BorderColor = UITheme.BorderColor
                        Item.BorderColor2 = Color.FromArgb(UITheme.BorderColor.ToArgb() Xor &HFFFFFF)

                    Case "CommonRoutines.UserControls.ProgressBar"
                        Dim Item As UserControls.ProgressBar = DirectCast(c, UserControls.ProgressBar)
                        Item.BackColor = Item.Parent.BackColor
                        Item.BorderColor = UITheme.BorderColor
                    ...
                    Case "CommonRoutines.UserControls.ProgressBarBase"
                        Dim Item As UserControls.ProgressBarBase = DirectCast(c, UserControls.ProgressBarBase)
                        Item.BackColor = Item.Parent.BackColor
                        Item.BorderColor = UITheme.BorderColor
                        Item.ChannelColor = Item.Parent.BackColor
                        Item.ForeBackColor = Item.Parent.BackColor
                    ...
                    Case "CommonRoutines.UserControls.RadioButton"
                        Dim Item As UserControls.RadioButton = DirectCast(c, UserControls.RadioButton)
                        Item.BackColor = Item.Parent.BackColor
                        Item.ForeColor = UITheme.ForeColor
                        Item.CheckedColor = UITheme.ForeColor
                        Item.UncheckedColor = UITheme.SelectionBackColor

                    Case "CommonRoutines.UserControls.TextBox"
                        Dim Item As UserControls.TextBox = DirectCast(c, UserControls.TextBox)
                        Item.BackColor = Item.Parent.BackColor
                        Item.BorderColor = UITheme.BorderColor
                        Item.BorderFocusColor = UITheme.SelectionBackColor
                    ...
                    Case "CommonRoutines.UserControls.ToggleButton"
                        Dim Item As UserControls.ToggleButton = DirectCast(c, UserControls.ToggleButton)
