...
Namespace Extensions
    ...
    Public Module System_Windows_Forms_Form
        ...
        <Runtime.CompilerServices.Extension()> Public Sub ShutDown(ByRef f As Form, prefix As String)
            ...
            Dim FormSizeLocation As Models.FormSizeLocation = If(Settings.Get(Of Models.FormSizeLocation)(Key), New Models.FormSizeLocation)
        ...
        <Runtime.CompilerServices.Extension()> Public Sub StartUp(ByRef f As Form, prefix As String)
            ...
            Select Case f.StartPosition
                ...
                Case Else
                    ...
                    FormSizeLocation = If(Settings.Get(Of Models.FormSizeLocation)(Key), New Models.FormSizeLocation With {
                        .Height = f.Height,
                        .Left = f.Left,
                        .Top = f.Top,
                        .Width = f.Width
