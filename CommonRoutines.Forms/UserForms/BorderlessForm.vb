...
#End Region
        ...
        Private Sub CheckIcons()
            If TitlePanel.BackColor.GetBrightness() >= 0.6! Then
                ClosePictureBox.Image = GetResourceImage(My.Resources.closeDark)
                If WindowState = FormWindowState.Normal Then
                    MaximizePictureBox.Image = GetResourceImage(My.Resources.maximizeDark)
                Else
                    MaximizePictureBox.Image = GetResourceImage(My.Resources.minimizeDark)
                End If
                MinimizePictureBox.Image = GetResourceImage(My.Resources.minusDark)
            Else
                ClosePictureBox.Image = GetResourceImage(My.Resources.closeLight)
                If WindowState = FormWindowState.Normal Then
                    MaximizePictureBox.Image = GetResourceImage(My.Resources.maximizeLight)
                Else
                    MaximizePictureBox.Image = GetResourceImage(My.Resources.minimizeLight)
                End If
                MinimizePictureBox.Image = GetResourceImage(My.Resources.minusLight)
            End If
        End Sub
