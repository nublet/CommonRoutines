...
#End Region
        ...
        Private Sub InitializeItems()
            ...
            BugPictureBox.Image = GetResourceImage(My.Resources.appbar_bug)
            IconPictureBox.Image = GetResourceImage(My.Resources.chat)
        End Sub
        ...
        Private Sub SetIcon(icon As MessageBoxIcon)
            Select Case icon
                Case MessageBoxIcon.Error
                    IconPictureBox.Image = GetResourceImage(My.Resources._error)
                ...
                Case MessageBoxIcon.Information
                    IconPictureBox.Image = GetResourceImage(My.Resources.information)
                    PrimaryColor = Color.FromArgb(38, 191, 166)

                Case MessageBoxIcon.Question
                    IconPictureBox.Image = GetResourceImage(My.Resources.question)
                    PrimaryColor = Color.FromArgb(10, 119, 232)

                Case MessageBoxIcon.Exclamation
                    IconPictureBox.Image = GetResourceImage(My.Resources.exclamation)
