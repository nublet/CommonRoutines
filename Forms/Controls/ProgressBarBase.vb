...
Namespace CommonRoutines.Controls
    ...
    Public Class ProgressBarBase
        ...
        Private Sub DrawValueText(sliderWidth As Integer, rectSlider As Rectangle, ByRef g As Graphics)
            Dim TextString As String = Replace(Text, "{Maximum}", Maximum.ToString(),,, CompareMethod.Text)
            TextString = Replace(TextString, "{Minimum}", Minimum.ToString(),,, CompareMethod.Text)
            TextString = Replace(TextString, "{Value}", Value.ToString(),,, CompareMethod.Text)
...
#Region " Overrides "
        ...
        Protected Overrides Sub OnPaint(e As PaintEventArgs)
            If Not _StopPainting Then
                Dim ScaleFactor As Double = (CDbl(Value) - Minimum) / (CDbl(Maximum) - Minimum)
