Namespace CommonRoutines.Extensions
    ...
    Public Module CommonRoutines_Controls_ComboBox

        <Runtime.CompilerServices.Extension()> Public Function GetSelectedComboItemValue(ByRef c As Controls.ComboBox) As String
        ...
        <Runtime.CompilerServices.Extension()> Private Sub PopulateComboItems(ByRef c As Controls.ComboBox, items As IEnumerable(Of Models.ComboItem))
        ...
        <Runtime.CompilerServices.Extension()> Public Sub PopulateComboItems(ByRef c As Controls.ComboBox, items As IEnumerable(Of String))
            c.PopulateComboItems(Nothing, items)
        End Sub

        <Runtime.CompilerServices.Extension()> Public Sub PopulateComboItems(ByRef c As Controls.ComboBox, fixedItems As IEnumerable(Of String), items As IEnumerable(Of String))
        ...
        <Runtime.CompilerServices.Extension()> Public Sub PopulateComboItems(ByRef c As Controls.ComboBox, items As IDictionary(Of String, String))
            c.PopulateComboItems(Nothing, items)
        End Sub

        <Runtime.CompilerServices.Extension()> Public Sub PopulateComboItems(ByRef c As Controls.ComboBox, fixedItems As IDictionary(Of String, String), items As IDictionary(Of String, String))
            Dim ComboItems As New List(Of Models.ComboItem)
            If fixedItems IsNot Nothing AndAlso fixedItems.Count > 0 Then
        ...
        <Runtime.CompilerServices.Extension()> Public Sub SelectComboItem(ByRef c As Controls.ComboBox, item As String)
            c.SelectComboItem(item, True)
        End Sub

        <Runtime.CompilerServices.Extension()> Public Sub SelectComboItem(ByRef c As Controls.ComboBox, item As String, autoAdd As Boolean)
            c.SelectedItem = Nothing
